...
public class TresEnRaya extends View {
    ...
    public static final int FICHA_X = 1;
    public static final int FICHA_O = 2;
    ...
    private int ganador;
    private boolean fin;
    private int casillasSeleccionadas;
    ...
    public void comprobarFin() {
        if (getCasilla(0, 0) != VACIA && getCasilla(0, 0) == getCasilla(0, 1) && getCasilla(0, 0) == getCasilla(0, 2)) {
            ganador = getCasilla(0, 0);
            fin = true;
        } else if (getCasilla(1, 0) != VACIA && getCasilla(1, 0) == getCasilla(1, 1) && getCasilla(1, 0) == getCasilla(1, 2)) {
            ganador = getCasilla(1, 0);
            fin = true;
        } else if (getCasilla(2, 0) != VACIA && getCasilla(2, 0) == getCasilla(2, 1) && getCasilla(2, 0) == getCasilla(2, 2)) {
            ganador = getCasilla(2, 0);
            fin = true;
        } else if (getCasilla(0, 0) != VACIA && getCasilla(0, 0) == getCasilla(1, 0) && getCasilla(0, 0) == getCasilla(2, 0)) {
            ganador = getCasilla(0, 0);
            fin = true;
        } else if (getCasilla(0, 1) != VACIA && getCasilla(0, 1) == getCasilla(1, 1) && getCasilla(0, 1) == getCasilla(2, 1)) {
            ganador = getCasilla(0, 1);
            fin = true;
        } else if (getCasilla(0, 2) != VACIA && getCasilla(0, 2) == getCasilla(1, 2) && getCasilla(0, 2) == getCasilla(2, 2)) {
            ganador = getCasilla(0, 2);
            fin = true;
        } else if (getCasilla(0, 0) != VACIA && getCasilla(0, 0) == getCasilla(1, 1) && getCasilla(0, 0) == getCasilla(2, 2)) {
            ganador = getCasilla(0, 0);
            fin = true;
        } else if (getCasilla(0, 2) != VACIA && getCasilla(0, 2) == getCasilla(1, 1) && getCasilla(0, 2) == getCasilla(2, 0)) {
            ganador = getCasilla(0, 2);
            fin = true;
        } else if (casillasSeleccionadas == 9) {
            ganador = 0;
            fin = true;
        } else {
            fin = false;
