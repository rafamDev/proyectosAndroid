...
public class AdaptadorJugadoresList extends RecyclerView.Adapter<AdaptadorJugadoresList.Vista_datos> implements View.OnClickListener {
    ...
    //Con este objeto adaptador creo el recycler con los objetos de la lista.
    public AdaptadorJugadoresList(ArrayList<Jugador> lista_jugadores) {
        this.lista_jugadores = lista_jugadores;
    }

    //Relleno el recycler con los datos obtenidos de la lista de jugadores. (con la clase interna: Vista_datos)
    @Override
    ...
    //Obtengo el jugador SELECCIONADO de la lista.
    @NonNull
    @Override
    ...
    //Clase interna para obtener las referencias y rellenar arriba el recycler con las variables.
